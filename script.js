...
class Calculator{
    ...
    // O método try catch executa o cálculo da expressão matemática contida em displayValue. Esse método utiliza a função eval() para a avaliar a expressão e, se for bem sucedida, atualiza o displayValue com o resultado e chama a função updateDisplay().Se ocorrer um erro durante a avaliação, ele atualiza o displayValue com a mensagem "Erro"e chama a função updateDisplay().
    calculate(){
        try{
